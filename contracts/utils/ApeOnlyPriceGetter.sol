...
library ApeOnlyPriceGetter {
    ...
    //Ape LP addresses
    address constant BUSD_NATIVE_PAIR = 0x51e6D27FA57373d8d4C256231241053a70Cb1d93; // busd is token1
    address constant DAI_NATIVE_PAIR = 0xf3010261B58B2874639Ca2e860E9005E3Be5DE0b;  // dai is token0
    address constant USDT_NATIVE_PAIR = 0x20bCC3b8a0091dDac2d0BC30F68E6CBb97de59Cd; // usdt is token0
    ...
    function getNativePrice() public view returns (uint) {
        (uint nativeReserve0, uint nativeReserve0,) = IApePair(DAI_NATIVE_PAIR).getReserves();
        (uint nativeReserve1, uint busdReserve,) = IApePair(BUSD_NATIVE_PAIR).getReserves();
        (uint usdtReserve, uint nativeReserve2,) = IApePair(USDT_NATIVE_PAIR).getReserves();
